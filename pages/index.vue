<template>
    <div class="main bg-slate-900 flex justify-center items-center mx-auto">
      ...
      <strong class="text-white text-sm md:text-lg text-center"
        >This is a simple chatbot that uses the GPT-3 API to generate responses.
        It's not perfect, but it's a fun way to play around with the API Use it to generate Recipes.
      </strong>
...
<div class="modal">
  <div class="modal-box relative">
    ...
    <h3 class="text-lg  font-light  bg-slate-800">
Ingredients:
...
<h3 class="text-lg  font-light  bg-slate-900">
instructions:
<p class="p-7 flex justify-start items-start mx-3 flex-col m-3 ">

<span>1. Bring a large pot of salted water to a boil. Add the pasta and cook according to package instructions. Drain and set aside. 
</span>
<span>2. Heat the olive oil in a large skillet over medium heat. Add the garlic and scallions and cook until fragrant, about 1 minute. </span>
<span>3. Add the cauliflower florets and cook until tender, about 5 minutes. </span>
<span>4. Add the cooked pasta to the skillet and stir to combine with the vegetables. Season with salt and pepper to taste. </span>
<span>5. Sprinkle the breadcrumbs over the top of the pasta mixture and stir to combine. Cook for an additional 2 minutes or until heated through and breadcrumbs are lightly browned</span>
<span>6. Serve warm with extra breadcrumbs on top if desired! Enjoy!</span>
      ...
      >
        <textarea
          ...
          v-model="prompt"
        ></textarea>
        <button type="submit" class="btn bg-slate-800 float-right bottom-2" :class="load ? ' cursor-not-allowed' : ''">
      ...
      <ClientOnly>
        <div class="flex justify-center items-center gap-x-2 flex-row   my-3">
          ...
          <button class="btn-2 bg-slate-800" @click="refresh"><Icon name="uil:refresh" class="h-6 w-6" />refresh</button>
        </div>
      </ClientOnly>
      <div
